...
<body>
    ...
    <div class="container py-5 top-position">
        <div class="col-md-5 m-auto">
            <h4 class="py-2">
                <c:out value="${user.firstName}" />, add a photo</legend>
            </h4>
            <!-- form  -->
            <div id="addform" class="p-4 border rounded bg-transparent">
                <form:form modelAttribute="photo" action="/photos/new" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <form:input id="caption" class="form-control" path="caption" />
                            </div>
                        </div>
